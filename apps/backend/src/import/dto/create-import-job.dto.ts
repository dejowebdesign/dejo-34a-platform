...
export class CreateImportJobDto {
  ...
  @ApiProperty({ enum: ImportJobStatus, enumName: 'ImportJobStatus' }) @IsEnum(ImportJobStatus) status!: ImportJobStatus;
  ...
  @ApiPropertyOptional({ description: 'Elapsed execution time in milliseconds.' }) @IsOptional() @IsInt() @Min(0) duration?: number;
