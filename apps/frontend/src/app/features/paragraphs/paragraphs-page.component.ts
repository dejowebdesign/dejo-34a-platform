...
interface ParagraphRow { id: string; number: string; title: string | null; currentVersion: string; law: string; }

@Component({
  imports: [MatButtonModule, MatFormFieldModule, MatInputModule, MatPaginatorModule, MatSortModule, MatTableModule, RouterLink],
  templateUrl: './paragraphs-page.component.html', styleUrl: '../law-engine-table.scss', changeDetection: ChangeDetectionStrategy.OnPush
})
