...
interface LawRow { id: string; abbreviation: string; name: string; version: string | null; }

@Component({
  imports: [MatButtonModule, MatFormFieldModule, MatInputModule, MatPaginatorModule, MatSortModule, MatTableModule, RouterLink],
  templateUrl: './laws-page.component.html', styleUrl: '../law-engine-table.scss', changeDetection: ChangeDetectionStrategy.OnPush
})
